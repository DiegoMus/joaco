...
if(!is_string($op) || preg_match('/\.\./', $op))
    die('¡Inténtalo de nuevo y te mataré! ¡Odio a los malditos hackers!');
...
<head>
	<meta charset="UTF-8">
	<title>UMG :: <?= htmlentities(ucfirst($op)); ?></title>
</head>
<body>
	<div id="header">
...
?>
	...
	<div id="footer">
		<div>
			<p>
			<span>2021 &copy; UMG.</span> Todos los derechos reservados.
			</p>
		</div>
	</div>
	</center>
